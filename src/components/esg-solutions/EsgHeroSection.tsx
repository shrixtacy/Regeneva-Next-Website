...
export const EsgHeroSection = () => {
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      const img = document.getElementById('floating-esg-hero-img');
      if (img) {
            ...
            <div class="w-layout-blockcontainer container hero w-container">
                <div class="inner-wrapper-hero">
                    ...
                    <div data-w-id="9dbda387-80ad-348b-eb23-191135b24f45" class="hero-wrapper">
                        <h1 class="h1 _w-808">Turn Sustainability Into a Competitive Advantage.</h1>
                        <div class="text-16-regular" style="position: absolute; top: 10%; right: 0; text-align: right; max-width: 400px; padding-right: 2rem;">Whether you're responding to investor expectations, preparing for evolving regulations, or embedding sustainability into your long-term business strategy, success begins with a clear roadmap.</div>
                        <div class="main-greenery-wrap" style="display: flex; justify-content: center; align-items: center; height: 100%; width: 100%;">
                            <img id="floating-esg-hero-img" src="/assets/hero-image.png" alt="ESG Solutions Design" style="max-width: 100%; max-height: 80vh; object-fit: contain; z-index: 10; position: relative; opacity: 1; transition: transform 0.1s ease-out;" />
                        </div>
                        ...
                        <h2 class="h1 _w-808" style="position: absolute; bottom: 0; right: 0; text-align: right; max-width: 600px;">ESG Strategy & Roadmap.</h2>
