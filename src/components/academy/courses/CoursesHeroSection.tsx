...
export const CoursesHeroSection = () => {
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      const img = document.getElementById('floating-course-hero-img');
      if (img) {
            ...
            <div style="-webkit-transform:translate3d(0, 0, 0) scale3d(0.97, 0.97, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 0, 0) scale3d(0.97, 0.97, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 0, 0) scale3d(0.97, 0.97, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 0, 0) scale3d(0.97, 0.97, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)" class="w-layout-blockcontainer container hero w-container">
                <div class="inner-wrapper-hero">
                    ...
                    <div data-w-id="9dbda387-80ad-348b-eb23-191135b24f45" class="hero-wrapper">
                        <h1 class="h1 _w-808">Master ESG. Build In-Demand Capabilities.</h1>
                        <div class="text-16-regular" style="position: absolute; top: 10%; right: 0; text-align: right; max-width: 400px; padding-right: 2rem;">ReGeneva Academy provides certified professional courses, CXO masterclasses, and corporate training programs designed by Big 4 & MBB sustainability leaders.</div>
                        <div class="main-greenery-wrap" style="display: flex; justify-content: center; align-items: center; height: 100%; width: 100%;">
                            <img id="floating-course-hero-img" src="/assets/hero-image.png" alt="ReGeneva Courses Hero Design" style="max-width: 100%; max-height: 80vh; object-fit: contain; z-index: 10; position: relative; transform: scale(1.3); transition: transform 0.1s ease-out;" />
                        </div>
                        ...
                        <h2 class="h1 _w-808" style="position: absolute; bottom: 0; right: 0; text-align: right; max-width: 600px;">Certified Learning Paths.</h2>
